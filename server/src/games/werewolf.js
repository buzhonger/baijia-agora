...
function roleBrief(g, seat) {
  ...
  s += ' 【日夜规则·严格遵守】'
    + '①夜晚=沉默行动：夜晚没有任何公开发言，所有玩家都在黑暗中静默执行自己的角色行动，不存在"今晚某人说了什么""昨晚的发言"这类说法——夜晚根本没有发言。'
    + '②夜晚行动完全私密：各角色单独行动，互相看不到也听不到彼此，白天绝不能说"昨晚观察到/听到某人的行为"——你不可能知道。'
    + '③发言只在白天：你能依据的只有"白天的公开发言"和"法官公布的死亡结果"，其余一律不知道。';
  return s;
}
